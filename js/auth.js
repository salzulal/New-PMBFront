// Select City Phone Code
  ...
  $(".select-pmb").each(function (e) {
    $(this).has('select').click(function (e) { 
      e.stopPropagation();
      selectPmb.empty();
      $(this).find("option").each(function(){
        selectPmb.append(
          '<div class="option" data-option="'+$(this).val()+'">'+$(this).text()+'</div>'
          );
        });
  ...
  selectPmb.on('click', ".option", function() {
    ...
    $(this).parents().find('select').val($(this).data("option"));
    $(this).parents().find('select').attr("value", $(this).data("option"));
  });
